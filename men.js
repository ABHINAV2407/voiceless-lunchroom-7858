function changebg(){
    ...
    }else if(scrollValue>850 && scrollValue<2100){
...
document.querySelector("#manbtn11").addEventListener("click",function(){
  
    changepage1();
})

document.querySelector("#manbtn22").addEventListener("click",function(){
